...
class FlutterOverlayWindow {
  ...
  /// Update overlay size/position through the main plugin channel.
  ///
  /// This avoids the MissingPluginException that can happen when
  /// [resizeOverlay] is called from the main app isolate on the overlay-only
  /// `x-slayer/overlay` channel.
  ...
  /// Update Android system gesture exclusion for the overlay view.
  ///
  /// This is routed through the main plugin channel so the main app and overlay
  /// isolate can both reach the active Android overlay service.
